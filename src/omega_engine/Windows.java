...
import omega_engine.Cenarios.Cenarios;
import omega_engine.Utils.Tempo;
...
public class Windows extends JFrame implements Runnable {
	...
	public omega_engine.Input.Mouse mMouse;
	public omega_engine.Input.Teclado mTeclado;
	...
	public Windows(String eTitulo, int eLargura, int eAltura) {
		...
		mMouse = new omega_engine.Input.Mouse();
		mTeclado = new omega_engine.Input.Teclado();
	...
	public omega_engine.Input.Mouse getMouse() {
		return mMouse;
	}

	public omega_engine.Input.Teclado getTeclado() {
		return mTeclado;
	}
